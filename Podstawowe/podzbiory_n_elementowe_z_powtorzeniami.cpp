...
int dlugosc_liczby(long long int zbior){
...
int main(){
    ...
    long long int zbior,dlugosc,i,maksb=0,kopia,kopia2,k,l,suma=0,a,b,c,n,j,podzbior,palindrom,h,g;
    ...
    for (i=1;i<g;i++){
        zbior=zbior+zbior*pow(10,dlugosc);
        dlugosc=dlugosc*2;
    }
    dlugosc=dlugosc_liczby(zbior); //zwracam dlugosc liczby
